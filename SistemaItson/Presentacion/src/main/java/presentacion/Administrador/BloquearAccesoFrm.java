 ...
 * @author adell
 */
public class BloquearAccesoFrm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("BLOQUEAR ACCESO");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BloquearAccesoFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BloquearAccesoFrm().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JButton cambiarAccesoBtn;
